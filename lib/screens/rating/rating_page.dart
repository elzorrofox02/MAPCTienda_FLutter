...
import 'package:hellowork/screens/rating/rating_dialog.dart';
                      ...
                      Column(
                        children: <Widget>[
                          Container(
                            ...
                            height: 92,
                            width: 92,
                            decoration: BoxDecoration(color: Colors.yellow, shape: BoxShape.circle, boxShadow: shadow, border: Border.all(width: 8.0, color: Colors.white)),
                            child: const ImageLoads(image: "holax.hppph"),
                          ),
                          const Padding(
...
//                      fillColor: Color(0xffFF8993),
                                  ...
                                  ratingWidget: RatingWidget(
                                    empty: const Icon(Icons.favorite_border, color: Color(0xffFF8993), size: 20),
                                    full: const Icon(
                                      Icons.favorite,
                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      const Padding(
                                        ...
                                        child: CircleAvatar(
                                          maxRadius: 14,
                                          //backgroundImage: AssetImage('icons/background.jpg'),
                                        ),
                                      ),
                                      Expanded(
                                        child: Column(
                                            ...
                                            Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: <Widget>[
                                                  ...
                                                  const Text(
                                                    '1 Comment',
                                                    style: TextStyle(color: Colors.blue, fontWeight: FontWeight.bold, fontSize: 10.0),
                                                  )
                                                ],
                                              ),
                                            )
